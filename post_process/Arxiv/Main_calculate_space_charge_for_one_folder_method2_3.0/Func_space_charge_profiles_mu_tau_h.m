...
function [rho_net,rho_net_mean,rho_dark, rho_Xray,mu_tau_h,mu_tau_h2,errorcode,coef_dark,coef_Xray,xx]=Func_space_charge_profiles_mu_tau_h(bias,current)
...
[rho_dark,xx_dark,coef_dark]=Func_space_charge_line_profile(Output_dark,Calib,1,20);%[e/cm^3]
[rho_Xray,xx_Xray,coef_Xray]=Func_space_charge_line_profile(Output_Xray,Calib,2,20);%[e/cm^3]
...
[mu_tau_h2]=Func_mu_tau_h_method2(rho_net_mean,current);%[cm^2/V] 
%% plot figure
figure,hold on
...
save(filename,'rho_dark','rho_net','rho_net_mean','rho_Xray','mu_tau_h','errorcode')
