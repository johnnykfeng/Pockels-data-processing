...
% and integration
% "Output" and "Calib" should be avaiable in the Workspace before running
% this code
...
%%
figure(1)
waitfor(msgbox(['Select the region of interest in E-field map']));
[x,points]=ginput(2);
...
xs=(0:(Edge_right_median-Edge_left_median))/T_median*2E-3;
