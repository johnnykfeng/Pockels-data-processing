...
if strcmp(calib_status,'Yes')
    ...
    Output=nan;
        ...
        bias_string=num2str(parameter(1,1));
        flux_string=num2str(parameter(1,2));
        ...
        [Output]=Read_Pockels_data_group_extraction(sensor_name,parameter(1,1),parameter(1,2));
        ...
        %         Calib.Edge_left_median= Edge_left_median;
        %         Calib.Edge_right_median= Edge_right_median;
        ...
        Calib.selected_region_edge1=points(2);
        Calib.selected_region_edge2=points(1);  
        end
        E_selected=Output.E_field_biased_corrected(Calib.selected_region_edge1:Calib.selected_region_edge2,:);%select a region the integation of E-field roughly equals to the bias applied
        ...
        Edge_left_sel=Edge_left(Calib.selected_region_edge1:Calib.selected_region_edge2);
        Edge_right_sel=Edge_right(Calib.selected_region_edge1:Calib.selected_region_edge2);
        ...
        xs2=(0:(Edge_right_median-Edge_left_median))/T_median*2E-3;
